...
<div class="container-12">
  <div id="copyright" class="grid-12">
    ...
    <a href="<?php shib_auth_generate_login_url() ?>" title="Site Administrator Login"><img src="<?php print base_path() . drupal_get_path('theme', 'q7') . '/images/user.gif' ?>" alt="Log In" class="user-auth-btn" /></a>
    <?php } else { ?>
