...
<div class="container-12">
  <div id="copyright" class="grid-12">
    ...
    <a href="https://<?php print $_SERVER['HTTP_HOST'] ?>/Shibboleth.sso/Login?target=<?php print urlencode("https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']) ?>" title="Site Administrator Login"><img src="<?php print base_path() . drupal_get_path('theme', 'q7') . '/images/user.gif' ?>" alt="Log In" class="user-auth-btn" /></a>
    <?php } else { ?>
