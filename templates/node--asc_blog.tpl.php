<article<?php print $attributes; ?>>
  ...
  <header>
    ...
    <?php ($teaser) ? print '<h2' : print '<h1' ?><h1<?php print $title_attributes; ?>><a href="<?php print $node_url ?>" title="<?php print $title ?>"><?php print $title ?></a><?php ($teaser) ? print '</h2>' : print '</h1>' ?>
  </header>
