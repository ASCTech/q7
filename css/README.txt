...
To use these stylesheets, rename the files and ascmath with the name of your theme.
...
ascmath-alpha-default-narrow.css  
...
ascmath-alpha-default-normal.css
...
ascmath-alpha-default-wide.css
