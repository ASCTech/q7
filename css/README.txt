...
To use these stylesheets, rename the files and asc_math with the name of your theme.
...
asc_math-alpha-default-narrow.css  
...
asc_math-alpha-default-normal.css
...
asc_math-alpha-default-wide.css
