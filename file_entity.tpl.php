...
<div id="file-<?php print $file->fid ?>" class="<?php print $classes ?>"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
    <?php
      ...
      hide($content['links']);
      $title = (isset($file->field_file_image_title_text['und'][0]) ? $file->field_file_image_title_text['und'][0]['safe_value'] : '');
      print '<a rel="lightbox[index]" title="' . $title . '" href="' . $file_url . '">' . render($content) . '</a>';
    ?>
  </div>
